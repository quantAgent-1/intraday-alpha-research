# A0 trial report — M3-A0-v1.1-ext-googl

Pooled plan-results rows: 483  (taken=392)
Sessions: 163
...
| vwap_magnet | 349      | 269   | 55        | 24       | 1    |
| TOTAL       | 483      | 392   | 66        | 24       | 1    |
...
| vwap_magnet | validate | 91      | 44         | 1.623        | -6.684  | 9.256  |
| POOLED      | train    | 261     | 106        | 0.697        | -4.958  | 5.876  |
| POOLED      | validate | 131     | 54         | 4.702        | -3.186  | 12.059 |
...
|----------------|---------|------------|--------------|---------|--------|
| base           | 392     | 160        | 2.036        | -2.464  | 6.402  |
| drop_top5      | 376     | 155        | -0.302       | -4.418  | 3.647  |
| double_spread  | 392     | 160        | 3.906        | -1.216  | 8.899  |
| double_latency | 392     | 160        | 2.777        | -1.666  | 7.096  |
| post_promo     | 392     | 160        | -11.964      | -16.464 | -7.598 |
...
```
{
  "n_plans": 392,
  "n_sessions": 160,
  "total_net_bps": 797.9768192185007,
  "top5_session_share": 1.142129721220977,
  "top_symbol_share": 1.0000000000000004,
  "top_payer_share": 0.861999229742443,
  "effective_n": 0.8193717009533849
}
```
...
{
  "gross_mid_bps": -0.276,
  "latency_drag_bps": -0.742,
  "spread_cost_bps": -1.87,
  "fees_bps": 0.3,
  "net_bps": 2.036
}
```
