# A0 trial report — M3-H2-v1-MU24

Pooled plan-results rows: 596  (taken=488)
Sessions: 295
...
|-------------|----------|-------|-----------|----------|------|
| expiry_pin  | 4        | 2     | 0         | 2        | 0    |
| gap_mr      | 25       | 25    | 0         | 0        | 0    |
| letf_window | 200      | 190   | 10        | 0        | 0    |
| vwap_magnet | 367      | 271   | 41        | 55       | 0    |
| TOTAL       | 596      | 488   | 51        | 57       | 0    |
...
|-------------|----------|---------|------------|--------------|---------|--------|
| expiry_pin  | train    | 2       | 2          | -7.476       | -8.026  | -6.926 |
| expiry_pin  | validate | 0       | 0          | null         | null    | null   |
| gap_mr      | train    | 25      | 25         | -8.016       | -63.946 | 45.147 |
| gap_mr      | validate | 0       | 0          | null         | null    | null   |
| letf_window | train    | 190     | 190        | -2.568       | -11.39  | 6.949  |
| letf_window | validate | 0       | 0          | null         | null    | null   |
| vwap_magnet | train    | 271     | 166        | -3.067       | -10.18  | 3.989  |
| vwap_magnet | validate | 0       | 0          | null         | null    | null   |
| POOLED      | train    | 488     | 289        | -3.145       | -9.106  | 2.858  |
...
|----------------|---------|------------|--------------|---------|---------|
| base           | 488     | 289        | -3.145       | -9.106  | 2.858   |
| drop_top5      | 477     | 284        | -6.207       | -11.577 | -0.769  |
| double_spread  | 488     | 289        | -5.005       | -11.16  | 1.186   |
| double_latency | 488     | 289        | -3.273       | -9.146  | 2.887   |
| post_promo     | 488     | 289        | -17.145      | -23.106 | -11.142 |
...
```
{
  "n_plans": 488,
  "n_sessions": 289,
  "total_net_bps": -1534.5328757153143,
  "top5_session_share": -0.9293097318962341,
  "top_symbol_share": 0.9999999999999994,
  "top_payer_share": 0.009743895528937969,
  "effective_n": 1.080341067781825
}
```
...
{
  "gross_mid_bps": -0.856,
  "latency_drag_bps": 0.128,
  "spread_cost_bps": 1.86,
  "fees_bps": 0.3,
  "net_bps": -3.145
}
```
