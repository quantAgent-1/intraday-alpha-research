# A0 trial report — M3-A0-MU24-h14
...
| vwap_magnet | train    | 347     | 191        | -2.351       | -8.034  | 3.305  |
| vwap_magnet | validate | 0       | 0          | null         | null    | null   |
| POOLED      | train    | 655     | 358        | -4.07        | -9.767  | 1.439  |
...
|----------------|---------|------------|--------------|---------|---------|
| base           | 655     | 358        | -4.07        | -9.767  | 1.439   |
| drop_top5      | 644     | 353        | -7.11        | -11.725 | -2.811  |
| double_spread  | 655     | 358        | -5.967       | -11.7   | -0.54   |
| double_latency | 655     | 358        | -3.956       | -9.66   | 1.527   |
| post_promo     | 655     | 358        | -18.07       | -23.767 | -12.561 |
...
```
{
  "n_plans": 655,
  "n_sessions": 358,
  "total_net_bps": -2665.646114239256,
  "top5_session_share": -0.7176578265875659,
  "top_symbol_share": 1.0000000000000002,
  "top_payer_share": 0.004802896362285775,
  "effective_n": 2.221097250130864
}
```
