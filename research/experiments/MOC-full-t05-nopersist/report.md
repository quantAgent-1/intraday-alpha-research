# M6 MOC-imbalance trial report — MOC-full-t05-nopersist
...
|--------|----------|------------|--------------|--------|-------|
| AMD    | 573      | 573        | 2.227        | -0.594 | 5.117 |
| GOOGL  | 603      | 603        | 1.351        | -0.538 | 3.296 |
| MU     | 587      | 587        | -1.199       | -4.387 | 2.181 |
| NVDA   | 587      | 587        | 2.515        | -0.655 | 5.462 |
| TSLA   | 560      | 560        | 0.524        | -2.915 | 3.955 |
| POOLED | 2910     | 618        | 1.085        | -0.677 | 2.787 |

## 3. Split-wise net_bps day-clustered CIs (train-period vs validate-period)

| split    | n_events | n_sessions | net_bps_mean | ci_lo  | ci_hi |
|----------|----------|------------|--------------|--------|-------|
| train    | 2614     | 555        | 1.23         | -0.573 | 2.848 |
