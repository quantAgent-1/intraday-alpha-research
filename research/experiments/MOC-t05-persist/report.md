# M6 MOC-imbalance trial report — MOC-t05-persist
...
```
{
  ...
  "events_fired": 2816,
  "skipped_no_cross": 0,
  "skipped_no_tape": 1370,
  "void": 0,
  "persistence_exits": 382
}
```
...
|--------|----------|------------|--------------|--------|-------|
| AMD    | 171      | 171        | 2.631        | -2.428 | 7.736 |
| GOOGL  | 179      | 179        | 1.049        | -2.224 | 4.089 |
| MU     | 568      | 568        | -0.818       | -3.985 | 2.498 |
| NVDA   | 361      | 361        | 4.204        | 0.6    | 7.772 |
| TSLA   | 167      | 167        | -1.962       | -7.136 | 3.015 |
| POOLED | 1446     | 588        | 0.943        | -1.125 | 2.973 |

## 3. Split-wise net_bps day-clustered CIs (train-period vs validate-period)

| split    | n_events | n_sessions | net_bps_mean | ci_lo  | ci_hi |
|----------|----------|------------|--------------|--------|-------|
| train    | 1150     | 525        | 0.969        | -1.318 | 3.144 |
| validate | 296      | 63         | 0.843        | -4.144 | 6.228 |
